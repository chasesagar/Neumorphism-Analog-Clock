...
How to make a Neumorphism analog clock using only simple HTML, CSS, and JavaScript programming code.See [demo](#demo)
...
- [Download from Github](https://github.com/chasesagar/Neumorphism-Analog-Clock/archive/master.zip).
- Clone the repo: `git clone https://github.com/chasesagar/Neumorphism-Analog-Clock.git`.
